          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <Textarea
                ...
                rows={2}
                className="bg-transparent dark:bg-transparent border-neutral-800 text-white placeholder:text-neutral-600 focus:border-neutral-600 rounded-none resize-none focus-visible:ring-0"
              />
            </div>
            <div>
              <label className="block text-sm text-neutral-400 mb-2">
                ...
                {criteria.map((criterion, index) => (
                  <div key={index} className="flex items-center gap-2">
                    <Input
                      ...
                      className="bg-transparent dark:bg-transparent flex-1 h-9 border-neutral-800 text-white placeholder:text-neutral-600 focus:border-neutral-600 rounded-none focus-visible:ring-0"
                    />
                    <Input
                      type="number"
                      ...
                      placeholder="%"
                      className="bg-transparent dark:bg-transparent w-16 h-9 border-neutral-800 text-white text-center placeholder:text-neutral-600 focus:border-neutral-600 rounded-none focus-visible:ring-0"
                    />
