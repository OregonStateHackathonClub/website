				...
				<Popover
					...
					<PopoverTrigger asChild>
						<Button
							...
							className={cn(
								"flex p-1 rounded-md border min-h-10 h-auto items-center justify-between bg-inherit hover:bg-inherit [&_svg]:pointer-events-auto hover:cursor-pointer",
													...
													<Badge
														...
														<div
															...
															aria-label={`Remove ${option.label} from selection`}
																className="ml-2 flex h-4 w-4 items-center justify-center cursor-pointer hover:bg-white/20 rounded-sm focus:outline-none focus:ring-1 focus:ring-white/50">															<XCircle
																className={cn(
																	"h-3 w-3",
																	responsiveSettings.compactMode &&
																		"h-2.5 w-2.5"
