...
export function DescriptionEditor({
  ...
  return (
    <div className="border border-neutral-800 bg-neutral-950/80 p-6">
      ...
      {showPreview ? (
        <div className="prose prose-sm prose-invert min-h-[200px] max-w-none border border-neutral-800 bg-neutral-900 p-4">
          {value ? (
        ...
        <div>
          <Textarea
            ...
            className="min-h-[200px] resize-y border-neutral-800 bg-neutral-900"
          />
