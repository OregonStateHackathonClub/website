                ...
                <div className="flex items-center justify-between gap-3 rounded-xl border border-gray-800 bg-gray-900 p-2 shadow-sm">
                  ...
                  <div className="flex gap-5">
                    ...
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent>
                        <DropdownMenuItem onClick={() => copyString(user.id)}>
                          {" "}
                          Copy User ID
                        </DropdownMenuItem>
                        {list === judges && (
      ...
      <div className="mx-auto w-full max-w-3xl py-10">
        ...
        {hackathonId ? (
          <div>
            ...
            {users ? (
              <Users list={judges} page={judgePage} setPage={setJudgePage} />
            ) : (
              <div>Loading...</div>
            )}
            ...
            {users ? (
              <Users list={users} page={userPage} setPage={setUserPage} />
            ) : (
              <div>Loading...</div>
            )}
          </div>
          ...
          <div>
            ...
            {users ? (
              <Users list={admins} page={adminPage} setPage={setAdminPage} />
            ) : (
              <div>Loading...</div>
            )}
            <div className="flex w-full justify-between items-center my-5">
