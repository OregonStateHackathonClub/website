            ...
            onClick={async () => {
              ...
              if (valid) {
                ...
                if (!finalDraftId) {
                  ...
                  if (
                    draftResult.data?.success &&
                    draftResult.data.draft?.draft?.id
                  ) {
                    ...
                    const errorMessage =
                      ...
                      "An unknown error occurred.";
                    toast(
                      `There was an error saving your draft: ${errorMessage}`,
                    );
                    return;
                  }
                } else {
                  ...
                  if (!draftResult.data?.success) {
                    const errorMessage =
                      ...
                      "An unknown error occurred.";
                    toast(
                      `There was an error updating your draft: ${errorMessage}`,
                    );
                    return;
                  }
                }
