    ...
    <div>
      ...
      <FormField
        ...
        render={({ field }) => (
          <FormItem className="w-full">
            <FormLabel>
              Mini Description* (Keep it short and sweet, full description goes
              in the next step)
            </FormLabel>
            <FormControl>
              <Textarea
                ...
                <div>
                  ...
                  >
                    <div className="flex flex-col items-center justify-center pt-5 pb-6 text-center pointer-events-none">
                      <UploadCloud
                        className={`w-8 h-8 mb-2 ${isDragging ? "text-orange-500" : "text-zinc-400"}`}
                      />
                        ...
                        {field.value.map((url: string, index: number) => (
                          ...
                          >
                            ...
                            <div className="flex items-center gap-3 overflow-hidden pointer-events-none">
                              {/* Number Index */}
                              <span className="text-zinc-500 font-mono text-sm w-4 text-center">
                                {index + 1}
                              </span>
